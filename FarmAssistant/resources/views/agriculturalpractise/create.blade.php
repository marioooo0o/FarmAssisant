...
<div class="create-container practise">
  <div class="content">
    <h1>Dodaj zabieg</h1>
    @if ($plantProtectionProducts->isEmpty())
    <div style="display: flex; justify-content:center; color:red">
      Nie posiadasz środków w magazynie musisz najpierw je dodać do magazynu
      <br>
      <br>
      <a style="background-color: #477e00;
      width:350px;
      color: white;
      border-radius: 20px;
      position: absolute;
      ...
      font-size: 20px;
      line-height: 30px;
      display: flex;justify-content:center " href = "{{ route('magazine.create', [$activeFarm->id]) }}">Dodaj środek do magazynu</a>
      <a href="route('magazine.create')"></a>
    </div>
