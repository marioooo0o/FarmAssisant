    ...
    <div class="create-container practise">
        <div class="content">
            ...
            <form action="{{ route('practise.update', [$activeFarm->id, $practise->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <input type="text" name="practise_name" placeholder="Nazwa zabiegu" 
                @if (old('practise_name'))
                ...
                @endif
                />
                @dump($practise->plantProtectionProducts->count())
                ...
                <div id="products-container">
                    <div class="product">
                      ...
                      <select name="protectionproduct[{{ $loop->index  }}][name]" class="input-protection input-protection--first">
                    ...
                    {{-- <div class="info-text">Maksymalna dawka środka: 0</div> --}}
                        <label>Ilość środka:<input class="input-quantity" type="number" min="0" max="150"
                                name="protectionproduct[{{ $loop->index }}][quantity]" value="{{ $productSelected->pivot->quantity }}"/></label>
                        l
